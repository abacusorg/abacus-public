export CXX = icc -openmp -liomp5 -xHost -fp-model precise -fbuiltin -ip -std=c++0x#-prof-use=weighted
...
export CXXFLAGS= -O3 -DGITVERSION=\"`git rev-parse HEAD`\" $(VERSIONFLAGS) #-ggdb3#-debug -debug parallel
