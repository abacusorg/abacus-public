...
gpudirect.o: gpu.cu Makefile
	nvcc --compiler-options  -I. -I/usr/local/cuda/include -ILibrary/include -arch compute_30 -code sm_30 -O3 -lineinfo -DGPUTHREADFORCESPIN -maxrregcount=32 -Xptxas="-v" -DUNIX -o $@ -c $<
