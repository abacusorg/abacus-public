...
gpudirect.o: gpu.cu Makefile
	nvcc -DGPUTHREADFORCESPIN --compiler-options -fno-strict-aliasing -I. -I/usr/local/cuda/include -arch compute_30 -code sm_30 -O3 -maxrregcount=32 -Xptxas="-v" -DUNIX -o $@ -c $<
