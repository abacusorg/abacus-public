...
gpudirect.o: gpu.cu Makefile
	nvcc --compiler-options -DGPUTHREADFORCESPIN -DNFRADIUS=2  -I. -I/usr/local/cuda/include -ILibrary/include -arch compute_30 -code sm_30 -O3 -lineinfo -maxrregcount=32 -Xptxas="-v" -DUNIX -o $@ -c $<
