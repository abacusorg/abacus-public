...
See the \texttt{python/choose\_cpd.py} utility for guidance on choosing this.
...
but also some useful utilities in \verb|python/Abacus|).
...
\subsection{Halo Interfaces (\texttt{python/Abacus/[Halos.py|Halotools.py]})}
...
\subsection{Abacus IO (\texttt{python/Abacus/ReadAbacus.py})}
