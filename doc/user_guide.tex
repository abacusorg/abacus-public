...
\todo{The State should compute ppd.  Drop from Parameter.}
...
executable distribution.  \todo{Drop this.}
...
\todo{State should include a FloatPrecision field.}
...
\todo{Implement in the directdriver code?}

\param{DirectDoublePrecision}{int} \todo{Remove this; it should be tied
to the compile precision and included in the WriteState.}
