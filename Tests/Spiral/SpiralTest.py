...
def run(basedir = "NONE"):
    ...
    if not os.path.exists(basedir+"write/state"):
        ...
        params = GenParam.makeInput(basedir+"spiral.par", abacuspath +"/Tests/Spiral/spiral.par2", NP = n1d**3,nTimeSlice = 1, TimeSliceRedshifts = 1/astop -1, SofteningLength = sf,InitialRedshift = 1/ainitial -1,CPD = 221,BoxSize = 17.3205080756888,WorkingDirectory = basedir)
